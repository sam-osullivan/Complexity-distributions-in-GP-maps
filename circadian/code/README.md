## Code for Plot (a) (b) and (c)
1. To solve ODE system for set of input parameters: (Vary length value "50" to adjust binary string lengths, as in Plot (c). Vary number of samples N to produce Plot (b))
